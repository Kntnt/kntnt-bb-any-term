 ...
 * GitHub Plugin URI: https://github.com/kntnt/kntnt-bb-any-term
...
final class Plugin {
    ...
    public function __construct() {
        ...
        // Make sure there is an "any term" in each public taxonomy.
        add_action( 'init', [ $this, 'control_term_id' ], 9999 );
